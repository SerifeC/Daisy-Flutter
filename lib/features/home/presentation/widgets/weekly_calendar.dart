...
class _WeeklyCalendarState extends State<WeeklyCalendar> with TickerProviderStateMixin {
                    ...
                    children: [
                      Material(
                        ...
                        child: IconButton(
                          ...
                          icon: AnimatedBuilder(
                            ...
                            builder: (BuildContext context, Widget child) =>Icon(Icons.arrow_back,color: _arrowColor.value,)
                      ...
                      Material(
                        ...
                        child: IconButton(
                          ...
                          icon: AnimatedBuilder(
                            animation: _arrowColor,
                            builder: (BuildContext context, Widget child) =>Icon(Icons.arrow_forward,color:_arrowColor.value,),
